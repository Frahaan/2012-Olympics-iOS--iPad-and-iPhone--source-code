...
#import "ScheduleiPad.h"


@implementation ScheduleiPad
...
- (UITableViewCell *) getCellContentView:(NSString *)cellIdentifier {
	...
	CGRect CellFrame = CGRectMake(0, 0, 1200, 70);
	CGRect Label1Frame = CGRectMake(10, 0, 500, 37);
	CGRect Label2Frame = CGRectMake(10, 33, 640, 25);
	UILabel *lblTemp;
